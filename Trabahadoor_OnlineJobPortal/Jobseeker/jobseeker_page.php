<?php
  ...
  if (isset($_GET["filter"])){
        ...
        $sql = "SELECT * FROM employer_info WHERE Industry LIKE '$filter_industry%' AND 
        (Work_schedule1 LIKE '$filter_ws' AND Work_schedule2 LIKE '$filter_ws' OR Work_schedule3 LIKE '$filter_ws')";
