...
if(isset($_POST['Submit'])){
    ...
    if(mysqli_num_rows($result) > 0){
      $error[] = 'User already exists, do you want to log in?';
...
<html>
    ...
    <!-- intro -->
            <div class="intro">
            <h4>Register to inclusive job opportunities.</h4>
            <p>&nbsp;Signing up would allow employers to discover you</p>
            </div>
    <!--Start of Reg Form-->
        <div class="Mainshowcase">
            <section class="Regform">
                ...
                ?>
                  ...
                  <div class="input-box">
                    <label>Type of Disability<i>(Kapansanan)</i></label>
