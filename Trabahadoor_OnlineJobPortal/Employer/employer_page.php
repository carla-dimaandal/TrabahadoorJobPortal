...
<form action="employer_page.php" method="get">
        <div class="filter-box">
            <label class="filter-txt"><i class="ri-filter-3-line"></i>&nbsp;Filters:</label>
            ...
            <?php
               if($result)  {
                while ($row = mysqli_fetch_assoc($result)) {
                  ...
                  <td>'.$email.'</td>
                  <td>'.$tod.'</td>
                  <td><button class="btn"><a class="btn-text" href="../Functions/viewimage.php?Resume='.$imageURL.'">View</button>
                  <td><button class="download-btn"><a class="icon-style" href=../Functions/download.php?Resume='.$imageURL.'"><i class="ri-download-2-line"></i></a></button></td>
