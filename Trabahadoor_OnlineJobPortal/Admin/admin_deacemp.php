<?php
    ...
    include 'admin_activate_emp.php';
            ...
            <?php
               ...
               if($result)  {
                while ($row = mysqli_fetch_assoc($result)) {
                  ...
                  <td>'.$fname.'</td>
                  <td>'.$cname.'</td>
                  <td style="text-align: center"><button class="btn"><a class="delete-btn" href="admin_deacemp.php?confirm='.$archive_empid.'"><i class="ri-checkbox-circle-line"></i></a></button></td>
                  </tr>';
                }
               }
