<?php
    ...
    include 'admin_activate_app.php';
    ...
    if (isset($_GET["search"])){
        ...
        $sql = "SELECT * FROM archive_app WHERE Archive_appID LIKE '$search%' OR Email LIKE '$search%' OR Fname LIKE '$search%' OR Age LIKE '$search%' OR Pnumber LIKE '$search%' 
            ...
            <div class="main">
               ...
               if($result)  {
                while ($row = mysqli_fetch_assoc($result)) {
                  ...
                  <td>'.$email.'</td>
                  <td>'.$fname.'</td>
                  <td style="text-align: center"><button class="btn"><a class="delete-btn" href="admin_deacapp.php?confirm='.$archive_appid.'"><i class="ri-checkbox-circle-line"></i></a></button></td>
                  </tr>';
                }
               }
